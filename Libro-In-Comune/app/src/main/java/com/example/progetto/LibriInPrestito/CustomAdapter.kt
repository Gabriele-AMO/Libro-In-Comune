...
import com.example.progetto.LibriInPrestito.ItemsVMLibriInPrestito as ItemsVMLibriInPrestito


class CustomAdapter(private val mList: List<ItemsVMLibriInPrestito>) : RecyclerView.Adapter<CustomAdapter.ViewHolder>() {
    ...
    interface OnClickListener {
        fun onClick(position: Int, model: ItemsVMLibriInPrestito)
    }

...
import com.example.progetto.LibriInPrestito.CustomAdapter
...
class CustomAdapterPreferiti(private val mList: List<ItemsVMPreferiti>) : RecyclerView.Adapter<CustomAdapterPreferiti.ViewHolder>() {
    ...
    interface OnClickListener {
        fun onClick(position: Int, model: ItemsVMPreferiti)
    }

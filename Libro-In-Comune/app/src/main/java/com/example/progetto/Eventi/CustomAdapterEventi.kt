...
import com.example.progetto.Eventi.ItemsVMEventi as ItemsVMEventi


class CustomAdapterEventi(private val mList: List<ItemsVMEventi>) : RecyclerView.Adapter<CustomAdapterEventi.ViewHolder>() {
    ...
    interface OnClickListener {
        fun onClick(position: Int, model: ItemsVMEventi)
    }
